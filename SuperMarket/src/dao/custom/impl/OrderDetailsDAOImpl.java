...
public class OrderDetailsDAOImpl implements OrderDetailsDAO {
    ...
    public boolean save(OrderDetails entity) throws SQLException, ClassNotFoundException {
        return SQLUtil.executeUpdate("INSERT INTO OrderDetails VALUES (?,?,?,?,?,?)",entity.getOrderId(), entity.getItemCode(),entity.getDescription(),entity.getOrderQty(), entity.getUnitPrice(),entity.getTotal());
    }
