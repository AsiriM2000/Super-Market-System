...
public class SearchOrderFormController {
    ...
    public void btnSearchOrder(ActionEvent actionEvent) {
        ...
        try {
            ...
            tblSearchOrder.getItems().add(new CustomTM(customer.getOrderId(), customer.getOrderDate(), customer.getCustId(), customer.getItemCode(), customer.getOrderQty(), customer.getUnitPrice()));
            txtOrderId.clear();
